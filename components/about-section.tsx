...
import { Brain, Code2, Cpu, Globe, Rocket, ShieldCheck, Sparkles, UserCheck } from "lucide-react"

export function AboutSection() {
  const stats = [
    { label: "GitHub Repositories", value: "9+", icon: Code2, color: "text-indigo-400" },
    { label: "Specialization", value: "AI & Edge", icon: Cpu, color: "text-cyan-400" },
    { label: "Core Stack", value: "Next.js / Python", icon: Globe, color: "text-emerald-400" },
    { label: "Degree", value: "BS SE (Ongoing)", icon: Rocket, color: "text-purple-400" },
  ]
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full glass-card border-indigo-500/30 mb-4">
              ...
              <span className="text-xs font-bold uppercase tracking-wider text-indigo-400">About Me</span>
            </div>
          ...
          {/* Bio Overview Card */}
          <div className="glass-card glass-card-hover rounded-3xl p-8 mb-12 border border-white/10 shadow-2xl relative overflow-hidden">
              ...
              return (
                ...
                >
                  <CardContent className="p-0">
                    <div className="p-3 rounded-2xl bg-slate-950/60 w-fit mb-4 border border-white/10">
