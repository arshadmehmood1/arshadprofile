...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-28 pb-16 overflow-hidden bg-grid-pattern">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-tr from-indigo-600/25 via-cyan-500/20 to-emerald-400/20 rounded-full blur-[140px] pointer-events-none animate-pulse-glow" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-blue-600/15 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute top-1/3 left-10 w-80 h-80 bg-indigo-500/15 rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14 mb-10 text-center md:text-left">
              ...
              <div className="animate-fade-in-up animate-delay-100 max-w-2xl">
                ...
                <p className="text-xl sm:text-2xl font-bold text-foreground/90 mb-4 flex items-center justify-center md:justify-start gap-2.5">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 animate-fade-in-up animate-delay-300">
              <Button
                ...
                size="lg"
                className="font-bold rounded-full bg-gradient-to-r from-indigo-600 to-cyan-500 hover:from-indigo-500 hover:to-cyan-400 text-white shadow-xl shadow-indigo-500/25 px-8 py-6 transition-all duration-300 hover:scale-105 flex items-center gap-2"
              >
                Explore Projects
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="font-bold rounded-full glass-card border-white/20 hover:bg-white/10 text-foreground px-8 py-6 transition-all duration-300 hover:scale-105 flex items-center gap-2"
              >
            ...
            <button
              ...
              className="mt-16 p-2 rounded-full text-muted-foreground hover:text-cyan-400 hover:bg-white/5 transition-all duration-300 animate-bounce"
